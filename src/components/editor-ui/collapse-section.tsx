    ...
    >
      <div className="flex items-start justify-between gap-4 px-4 py-3.5">
        <button
          ...
          className="flex min-w-0 flex-1 items-start justify-between gap-4 text-left transition-colors hover:text-[#23422a] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#23422a]/20"
        >
          ...
          <ChevronDown
            className={cn(
              "mt-0.5 h-4 w-4 shrink-0 text-[#727971] transition-transform duration-200",
        ...
        {action ? (
          <div className="flex shrink-0 items-center gap-3 pl-2" onClick={(event) => event.stopPropagation()}>
            {action}
          </div>
        ) : null}
      </div>
